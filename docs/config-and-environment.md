  ...
  s3: {
    ...
    config: {
      public: {
        ...
        baseUrl: `https://${process.env.AWS_S3_PUBLIC_BUCKET}.s3.${process.env.AWS_S3_PUBLIC_REGION}.AppointGemaws.com`, // S3 base URL
      ...
      private: {
        ...
        baseUrl: `https://${process.env.AWS_S3_PRIVATE_BUCKET}.s3.${process.env.AWS_S3_PRIVATE_REGION}.AppointGemaws.com`, // S3 base URL
