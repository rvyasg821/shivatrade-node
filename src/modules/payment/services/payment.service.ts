...
export class PaymentService implements IPaymentService {
    ...
    async processPayPalCardPaymentForSubscriptionUpdate(
        ...
        try {
            ...
            //     const paymentData = {
            //         _id: uuidv4(),
            //         cacurrency:data.currency,
            //         total:data.total,
            //         card_token_id: CardToken,
            //         redirect_url: data.redirect_url ?? "http://localhost.com",
            //         type:"PAYMENT_TOKEN",
            //     }
            //     const createdCharge = await this.paypalService.checkoutPaymentOrder(CardToken, paymentData);
            ...
            //         console.log('createdPayment?._id', createdPayment);
