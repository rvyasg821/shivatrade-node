...
const EVENT_TYPE_LABELS: Record<string, string> = {
    ...
    [ENUM_TRACKING_EVENT_TYPE.POV_PAYMENT_RECORDED]: 'Payment Recorded',
    [ENUM_TRACKING_EVENT_TYPE.POV_PAYMENT_VOIDED]: 'Payment Voided',
    [ENUM_TRACKING_EVENT_TYPE.GRN_CONFIRMED]: 'GRN Confirmed',
    [ENUM_TRACKING_EVENT_TYPE.GRN_CANCELLED]: 'GRN Cancelled',
    [ENUM_TRACKING_EVENT_TYPE.DEBIT_NOTE_ISSUED]: 'Debit Note Issued',
    [ENUM_TRACKING_EVENT_TYPE.DEBIT_NOTE_CANCELLED]: 'Debit Note Cancelled',
};
