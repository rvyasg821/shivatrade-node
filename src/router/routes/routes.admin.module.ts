...
import { VendorCategoryAdminController } from '@modules/vendor-category/controllers/vendor-category.admin.controller';
...
@Module({
    controllers: [
        ...
        // Vendor-category master controller
        VendorCategoryAdminController,
